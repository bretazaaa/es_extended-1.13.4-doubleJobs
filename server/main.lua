...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    -- Job 2
    local job2 = (result.job2 and result.job2 ~= "") and result.job2 or "unemployed2"
    local grade2 = (result.job2_grade and result.job2_grade ~= 0) and tostring(result.job2_grade) or "0"
