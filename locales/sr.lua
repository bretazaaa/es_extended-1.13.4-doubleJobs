return {
    ...
    ["command_setjob2"] = "Podesi organizaciju igrača",
    ["command_setjob2_invalid"] = "Posao, rang ili oba su nevažeći",
    ["command_setjob2_job"] = "Naziv posla za postavljanje",
    ["command_setjob2_grade"] = "Rang posla",
}
