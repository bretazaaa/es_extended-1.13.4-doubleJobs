return {
    ...
    ["command_setjob2"] = "Organisatie van een speler instellen",
    ["command_setjob2_invalid"] = "Baan, rang of beide zijn ongeldig",
    ["command_setjob2_job"] = "Naam van de in te stellen baan",
    ["command_setjob2_grade"] = "Baan rang",
}
