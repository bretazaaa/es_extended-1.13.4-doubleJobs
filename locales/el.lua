return {
    ...
    ["command_setjob2"] = "Ορισμός οργάνωσης παίκτη",
    ["command_setjob2_invalid"] = "Το επάγγελμα, ο βαθμός ή και τα δύο είναι άκυρα",
    ["command_setjob2_job"] = "Όνομα επαγγέλματος προς ορισμό",
    ["command_setjob2_grade"] = "Βαθμός επαγγέλματος",
}
