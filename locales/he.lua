return {
    ...
    ["command_setjob2"] = "הגדר ארגון לשחקן",
    ["command_setjob2_invalid"] = "העבודה, הדרגה או שניהם אינם תקינים",
    ["command_setjob2_job"] = "שם העבודה להגדרה",
    ["command_setjob2_grade"] = "דרגת העבודה",
}
