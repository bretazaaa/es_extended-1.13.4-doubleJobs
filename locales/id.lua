return {
    ...
    ["command_setjob2"] = "Atur organisasi pemain",
    ["command_setjob2_invalid"] = "Pekerjaan, pangkat, atau keduanya tidak valid",
    ["command_setjob2_job"] = "Nama pekerjaan yang akan diatur",
    ["command_setjob2_grade"] = "Pangkat pekerjaan",
}
