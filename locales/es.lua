return {
    ...
    ["command_setjob2"] = "Definir la organización de un jugador",
    ["command_setjob2_invalid"] = "El trabajo, el rango o ambos son inválidos",
    ["command_setjob2_job"] = "Nombre del trabajo a definir",
    ["command_setjob2_grade"] = "Rango del trabajo",
}
