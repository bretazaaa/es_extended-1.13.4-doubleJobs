return {
    ...
    ["command_setjob2"] = "Ställ in en spelares organisation",
    ["command_setjob2_invalid"] = "Jobbet, graden eller båda är ogiltiga",
    ["command_setjob2_job"] = "Jobbnamn att ställa in",
    ["command_setjob2_grade"] = "Jobbgrad",
}
