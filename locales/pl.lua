return {
    ...
    ["command_setjob2"] = "Ustaw organizację gracza",
    ["command_setjob2_invalid"] = "Praca, stopień lub oba są nieprawidłowe",
    ["command_setjob2_job"] = "Nazwa pracy do ustawienia",
    ["command_setjob2_grade"] = "Stopień pracy",
}
