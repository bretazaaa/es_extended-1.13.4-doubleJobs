return {
  ...
  ["command_setjob2"] = "Définir l'oganisation d'un joueur",
  ["command_setjob2_invalid"] = "Le métier, le grade, ou les deux sont invalides",
  ["command_setjob2_job"] = "Nom du métier à définir",
  ["command_setjob2_grade"] = "Grade du métier",

  ["command_setorga"] = "Définir l'oganisation d'un joueur",
  ["command_setorga_invalid"] = "L'organisation, le grade, ou les deux sont invalides",
  ["command_setorga_orga"] = "Nom de l'organisation à définir",
  ["command_setorga_grade"] = "Grade de l'organisation",

  ["command_setgang"] = "Définir l'oganisation d'un joueur",
  ["command_setgang_invalid"] = "Le gang, le grade, ou les deux sont invalides",
  ["command_setgang_gang"] = "Nom du gang à définir",
  ["command_setgang_grade"] = "Grade du gang",
