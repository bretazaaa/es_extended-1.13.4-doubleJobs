return {
    ...
    ["command_setjob2"] = "Imposta l'organizzazione di un giocatore",
    ["command_setjob2_invalid"] = "Il lavoro, il grado o entrambi non sono validi",
    ["command_setjob2_job"] = "Nome del lavoro da impostare",
    ["command_setjob2_grade"] = "Grado del lavoro",
}
