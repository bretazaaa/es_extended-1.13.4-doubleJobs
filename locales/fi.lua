return {
    ...
    ["command_setjob2"] = "Aseta pelaajan organisaatio",
    ["command_setjob2_invalid"] = "Työ, arvo tai molemmat ovat virheellisiä",
    ["command_setjob2_job"] = "Asetettava työn nimi",
    ["command_setjob2_grade"] = "Työn arvo",
}
