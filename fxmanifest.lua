...
game 'gta5'
author1 "https://github.com/esx-framework/esx_core"
author2 "https://github.com/bretazaaa" -- Modification du double job apporter par moi
description 'ESX Legacy double job system'
lua54 'yes'
version '1.13.4'
